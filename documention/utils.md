...
|---|---|---|---|
| WGCNA (WGCNA class) | WGCNA object | None | None |
| sc (dataframe) | gene marker table which has .... | None | None |

**Returns:**

| Type | Description |
|---|---|
| compare (Compare class) | None |
...
| Name | Type | Description | Default |
|---|---|---|---|
| WGCNA1 (WGCNA class) | first WGCNA object | None | None |
| WGCNA2 (WGCNA class) | second WGCNA object | None | None |
...
| Name | Type | Description | Default |
|---|---|---|---|
| dataset | name of the dataset we used from biomart; mouse: mmusculus_gene_ensembl and human: hsapiens_gene_ensembl | None | None |
| you can find more information here | https://bioconductor.riken.jp/packages/3.4/bioc/vignettes/biomaRt/inst/doc/biomaRt.html#selecting-a-biomart-database-and-dataset | None | None |
| attributes | List the types of data we want | None | None |

**Returns:**

| Type | Description |
|---|---|
| dictionary contain gene id as a key and gene name as a value | None |
...
| Name | Type | Description | Default |
|---|---|---|---|
| file (str) | Name / path of comparison object | None | None |
...
| Name | Type | Description | Default |
|---|---|---|---|
| file (str) | Name / path of WGCNA object | None | None |
