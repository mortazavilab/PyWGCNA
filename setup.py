...
setup(
    ...
    version='v0.1.8-alpha',  # version number
    ...
    download_url='https://github.com/mortazavilab/PyWGCNA/archive/refs/tags/v0.1.8-alpha.tar.gz',  # link to the tar.gz file associated with this release
