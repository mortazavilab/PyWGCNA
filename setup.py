...
setup(
    ...
    version='v0.0.7-alpha',  # version number
    ...
    download_url='https://github.com/mortazavilab/PyWGCNA/archive/refs/tags/v0.0.7-alpha.tar.gz',  # link to the tar.gz file associated with this release
