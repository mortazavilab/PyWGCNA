...
setup(
    ...
    version='v0.0.5-alpha',  # version number
    ...
    download_url='https://github.com/mortazavilab/PyWGCNA/archive/refs/tags/pre_release.tar.gz',  # link to the tar.gz file associated with this release
